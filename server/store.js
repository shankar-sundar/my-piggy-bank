...
const users = [
  { id: 1, username: 'admin', password_hash: bcrypt.hashSync('piggy123', 10) },
];

const accounts = [
  { id: 1, user_id: 1, type: 'spend', account_number: 'ACC · 0001 · 8821', balance: 1240.50 },
  { id: 2, user_id: 1, type: 'save',  account_number: 'ACC · 0002 · 4473', balance: 8905.00 },
  { id: 3, user_id: 1, type: 'share', account_number: 'ACC · 0003 · 7729', balance: 620.75  },
];
...
function buildTransactions() {
  ...
  for (const acc of accounts) {
    const rows = txnTemplates[acc.type];
    rows.forEach((t, i) => {
      ...
      result.push({
        ...
        reference: 'TXN' + String(100000 + id),
        type: t.type,
        amount: t.amount,
      });
    });
